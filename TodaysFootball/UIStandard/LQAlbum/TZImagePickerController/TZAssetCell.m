...
- (void)setModel:(TZAlbumModel *)model {
    ...
    self.subtitleLable.text = @(model.count).description;
...
- (UILabel *)titleLable {
    if (_titleLable == nil) {
        ...
        titleLable.frame = CGRectMake(80, 15, self.tz_width - 80 - 50, 20);
...
- (UILabel *)subtitleLable {
    if (_subtitleLable == nil) {
        ...
        subtitleLable.frame = CGRectMake(80, 35, self.tz_width - 80 - 50, 20);

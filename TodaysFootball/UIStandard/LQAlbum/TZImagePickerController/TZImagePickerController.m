...
//        self.navigationBar.tintColor = [UIColor whiteColor];
        ...
        [self.navigationBar setBackgroundImage:[UIImage imageNamed:@"MCStandard.bundle/public_title_bg"] forBarMetrics:UIBarMetricsDefault];
        self.navigationBar.translucent = NO;
        self.navigationBar.tintColor = [UIColor whiteColor];
        self.navigationBar.backIndicatorImage = [UIImage imageNamed:@""];
        self.navigationBar.backIndicatorTransitionMaskImage = [UIImage imageNamed:@""];
...
//            if (iOS7Later) top += 20;
            CGFloat top = 0;
            _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, top, self.view.tz_width, self.view.tz_height - 64) style:UITableViewStylePlain];
